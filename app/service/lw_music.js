...
module.exports = class LwMusicService extends Service {

    /**
     * create a new lw_music
     * @param {Object} entity  model lw_music
     * @return {Object} entity a model Entity
     */
    async create(entity) {
        if (typeof entity !== 'object') throw new Error('entity must be Object');
        try {
            const result = await this.ctx.model.LwMusic.create(entity);
            return result;
        } catch (err) {
            throw err;
        }
    ...
    async getById(Id) {
        ...
        try {
            const result = await this.ctx.model.LwMusic.findOne({
                where: {
                    Id: Id
                }
            });
    ...
    async edit(entity) {
        ...
        try {
            const newEntity = await this.ctx.model.LwMusic.update(entity, {
                where: {
                    Id: entity.Id
                }
            });
    ...
    async remove(entity) {
        ...
        try {
            entity.Valid = 0;
            return await this.ctx.service.lwMusic.edit(entity);
        } catch (error) {
            throw error;
        }
    }
    ...
    /**
     * delete a record from lw_music
     * @param {Object} entity a model Entity
     * @return {Object} affact count
     */
    async delete(entity) {
        try {
            const result = await this.ctx.model.LwMusic.destroy({
                where: {
                    Id: entity.Id
                }
            });
    ...
    async search(pagination, where, order) {
        ...
        try {
            ...
            let entityList = await this.ctx.model.LwMusic.findAndCountAll(condition);
            return entityList;
        } catch (err) {
            throw err;
        }
